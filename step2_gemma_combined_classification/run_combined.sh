...
#SBATCH --mem=150G
#SBATCH --job-name=rl_combined_classification
#SBATCH --output=Outputs/combined_%j_%N.out
#SBATCH --error=Outputs/combined_%j_%N.err
#SBATCH --exclude=c001,c002,c003,c006

WORKDIR=/gpfs/home/fl488/process_RL_sasb/gemma_combined_classification
INPUT_CSV=/gpfs/home/fl488/process_RL_sasb/gemma_role_classification/comparison_sasb.csv
OUTPUT_CSV=$WORKDIR/gemma_combined_classification_output.csv
...
srun \
  --output=$WORKDIR/Outputs/combined_srun_%j_%N.out \
  --error=$WORKDIR/Outputs/combined_srun_%j_%N.err \
  bash -lc '
  ...
  /gpfs/project/populism/venv/bin/python $WORKDIR/gemma_combined_classification.py \
    --input-csv /gpfs/home/fl488/process_RL_sasb/gemma_role_classification/comparison_sasb.csv \
    --output-csv /gpfs/home/fl488/process_RL_sasb/gemma_combined_classification/gemma_combined_classification_output.csv \
