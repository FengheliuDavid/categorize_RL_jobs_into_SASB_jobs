...
- A category qualifies ONLY if the job description explicitly states responsibilities that directly manage that SASB area as a core function
- Use the full description text — explicit keywords and duties are the only basis for classification
...
**The key test:** Does the description explicitly describe managing, overseeing, or being accountable for that SASB area? Merely working at a company that operates in a relevant industry is not sufficient.
