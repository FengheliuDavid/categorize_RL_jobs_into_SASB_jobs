"""
Classify role_combinations.csv into SASB categories using Claude Sonnet.
Processes 10 roles per API call. Saves results to output_sasb_claude.csv.
Automatically resumes from checkpoint if interrupted.

Usage:
    set ANTHROPIC_API_KEY=your_key_here
    python claude_classify_roles.py
"""
...
OUTPUT_CSV  = BASE / "output_sasb_claude.csv"
